...
assert_file_contains "${git_skills_runtime_manifest}" '] }'
...
assert_file_contains "${generic_skill_file}" 'Do not skip this by immediately handing off implementation before you understand the change.'
assert_file_contains "${generic_skill_file}" 'Choose the appropriate available agent for the work at hand.'
...
assert_file_not_contains "${generic_skill_file}" 'implementation-focused agent'
assert_file_not_contains "${generic_skill_file}" 'review-coordinator-agent'
