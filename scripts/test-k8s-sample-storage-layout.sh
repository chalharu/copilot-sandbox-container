...
assert_resource_contains ConfigMap control-plane-instance-env 'CONTROL_PLANE_ACP_HOST: control-plane-acp.copilot-sandbox.svc.cluster.local'
...
assert_overlay_resource_present Service control-plane-acp
...
assert_overlay_resource_contains ConfigMap control-plane-instance-env 'CONTROL_PLANE_ACP_HOST: control-plane-acp.custom-sandbox.svc.cluster.local'
...
assert_resource_present Service control-plane-acp
...
assert_resource_contains Service control-plane 'name: http'
assert_resource_contains Service control-plane 'port: 8080'
assert_resource_contains Service control-plane 'targetPort: http'
assert_resource_contains Service control-plane-acp 'name: acp'
assert_resource_contains Service control-plane-acp 'port: 3000'
assert_resource_contains Service control-plane-acp 'targetPort: acp'
...
assert_deployment_contains '- control-plane-copilot'
...
assert_resource_contains Deployment control-plane-web 'command:'
assert_resource_contains Deployment control-plane-web '/usr/local/bin/control-plane-web'
assert_resource_contains Deployment control-plane-web 'app.kubernetes.io/component: web'
assert_resource_contains Deployment control-plane-web 'runAsNonRoot: true'
...
assert_resource_not_contains Deployment control-plane-web 'name: cache'
assert_resource_not_contains Deployment control-plane-web 'mountPath: /var/tmp/control-plane'
