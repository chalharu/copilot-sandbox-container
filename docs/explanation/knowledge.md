...
- **Control Plane** は Copilot CLI、`gh`、`git`、`kubectl`、SSH、GNU Screen、bundled toolchain を持つ長寿命の操作面
...
を優先し、sample manifest と current-cluster smoke の既定を
`CONTROL_PLANE_RUN_MODE=k8s-job` に寄せています。
