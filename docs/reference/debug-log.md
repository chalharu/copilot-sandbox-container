...
| SSH が切れる / `cleanup_exit` が出る | [§3](#3-legacy-interactive-ssh-で切れる--sshd-cleanup-警告が出る) |
...
| interactive SSH が Copilot session へ入らない | [§7](#7-legacy-interactive-ssh-が-copilot-session-へ入らない) |
