...
| SSH が切れる / `cleanup_exit` が出る | [§3](#symptom-legacy-ssh-cleanup) |
...
| interactive SSH が Copilot session へ入らない | [§7](#symptom-legacy-ssh-session) |
...
<a id="symptom-legacy-ssh-cleanup"></a>
...
<a id="symptom-legacy-ssh-session"></a>
