...
します。現在は generic な implementation agent に加え、KISS/DRY・SOLID・
security・architecture 向けの generic review agent 群と review coordinator
agent を同梱し、skill と同じく user-owned copy を使って file mode を明示的に
整えています。これにより、
