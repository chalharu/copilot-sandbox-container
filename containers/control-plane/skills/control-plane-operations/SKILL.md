...
- Package finished changes with `python3 .github/skills/skill-creator/scripts/package_skill.py <skill-dir>` when you are editing inside this repository and want structure validation.
