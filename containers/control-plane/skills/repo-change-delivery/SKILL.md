...
2. Delegate with sub-agents when they help.
   ...
   - Choose an appropriate implementation sub-agent from the available agents; prefer an implementation-focused agent when one is available and relevant, and use task agents for command-heavy edits and validation loops.
